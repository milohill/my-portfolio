    ...
    <div className="projects">
      ...
      <div className="projects__project-container">
        ...
        <div className="projects__project-text">
          <h3 className="projects__project-name">Random Password Generator</h3>
          <p className="projects__project-description">
            In this project, I developed a personal finance tracker app to help
            users manage their finances effectively. The app allows users to
            input income, expenses, and savings data, and then it generates
            visualizations and reports to give users a comprehensive overview of
      ...
      <div className="projects__project-container">
        <div className="projects__project-text">
          ...
          <p className="projects__project-description">
            ...
            endeavor that brings the ultimate rollercoaster experience to life,
            transcending reality and immersing users in a virtual realm of
